/**
 * Shell message dictionary — brand, language switcher, sidebar navigation,
 * header, and per-screen titles/subtitles. Arabic is the source of truth; the
 * English map mirrors it key-for-key (enforced by the Record type).
 *
 * See ./index-style aggregation in ../messages.ts. Every module file follows the
 * same shape: `<name>Ar` as a const object, `<name>En` a Record over its keys.
 */
...
export const shellEn: Record<keyof typeof shellAr, string> = {
